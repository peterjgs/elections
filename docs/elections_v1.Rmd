...
ggsave(file = "../figs/house_grn_first_pref_pc_macquarie_1.pdf", dev = "pdf")
...
poll_place_plot_data <- 
  hvotes2025_elect_grn_pc %>%
  slice(., 32:63)

ggplot(poll_place_plot_data, aes(x = PollingPlace, y = grn_pc)) +
  geom_point() +
  #guides(shape = guide_legend(title = "Year")) +
  labs(title = "House of Reps Macquarie: Greens percent. first pref. votes - 2025",
       #subtitle = "AEC data at 2025-05-18",
       subtitle = paste("AEC data at", date_data, sep = " "), 
       x = "Polling Place", y = "Percentage of votes in electorate") +
  theme(axis.text.x = element_text(angle = 75, vjust = 0.5))

## Save plot

ggsave(file = "../figs/house_grn_first_pref_pc_macquarie_2.pdf", dev = "pdf")
